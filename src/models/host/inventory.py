...
class DailyInventory(BaseModel):
    ...
    inventory_ooi: int | None = Field(None, alias="inventoryOOI")  # Out of inventory
    inventory_ooo: int | None = Field(None, alias="inventoryOOO")  # Out of order
    rate: float | None = None  # Base rate for the day
    status: str | None = None  # AVAILABLE, SOLD_OUT, CLOSED, etc.
...
class RoomInventory(BaseModel):
    ...
    daily_inventories: list[DailyInventory] = Field(default_factory=list, alias="dailyInventories")
...
class InventoryResponse(BaseModel):
    ...
    room_inventories: list[RoomInventory] = Field(default_factory=list, alias="roomInventories")
